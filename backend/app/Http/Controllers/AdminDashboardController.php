            ...
            foreach ($bookings as $booking) {
                ...
                $events[] = [
                    ...
                    'extendedProps' => [
                        ...
                        'adult_tickets' => $booking->adult_tickets ?? 0,
                        'teenager_tickets' => $booking->teenager_tickets ?? 0,
                        'university_tickets' => $booking->university_tickets ?? 0,
                        'child_tickets' => $booking->child_tickets ?? 0,
        ...
        try {
            ...
            return response()->json([
                ...
                'booking' => [
                    ...
                    'teenager_price' => $booking->teenager_price ?? 0,
                    'university_price' => $booking->university_price ?? 0,
                    'child_price' => $booking->child_price ?? 0,
                    'total_amount' => $booking->total_amount,
