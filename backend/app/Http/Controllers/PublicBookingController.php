    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'adult_tickets' => 'nullable|integer|min:0',
                'teenager_tickets' => 'nullable|integer|min:0',
                'university_tickets' => 'nullable|integer|min:0',
            ...
            $bookingData = [
                ...
                'teenager_tickets' => $request->teenager_tickets ?? 0,
                'university_tickets' => $request->university_tickets ?? 0,
                'child_tickets' => $request->child_tickets ?? 0,
                'quantity' => $request->quantity,
                'event_date' => $request->event_date,
                'adult_price' => $request->adult_price ?? 0,
                'teenager_price' => $request->teenager_price ?? 0,
                'university_price' => $request->university_price ?? 0,
